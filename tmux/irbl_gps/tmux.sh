...
'
  'Core' 'ros2 launch mrs_uav_core core.launch.py platform_config:=`ros2 pkg prefix mrs_uav_deployment`/share/mrs_uav_deployment/config/mrs_uav_system/$UAV_TYPE.yaml world_config:=./config/world_temesvar_field.yaml custom_config:=./config/custom_config.yaml network_config:=./config/network_config.yaml
'
...
'
  'livox' 'ros2 launch livox_ros_driver2 livox.launch.py
'
