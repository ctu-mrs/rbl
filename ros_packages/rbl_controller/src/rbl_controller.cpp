                                                                                   ...
                                                                                   const double&                                    altitude)
{
  ...
  if (cloud->size() <= 0) {
    ROS_WARN("[RBLController]: PointCloud is empty. Can not clean ground");
    return nullptr;
  }
...
{ 
  ...
  if (num_points == 0) {
    ROS_WARN("[RBLController]: Mapping cloud ptr to Eigen::Matrix3Xd not possible, cloud is empty.");
    return false;
  }
